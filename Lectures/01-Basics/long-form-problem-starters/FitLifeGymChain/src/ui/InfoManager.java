...
public class InfoManager {
    ...
    private static final String PEN_ISLAND_GYM_COMMAND = "penisland";
    ...
    private void printInstructions(){
        ...
        System.out.println("Enter '" + PEN_ISLAND_GYM_COMMAND + "' for Fitlife " + PEN_ISLAND_GYM_NAME);
    ...
    private void registerMemberForClass(Member m, FitnessClass fc){
        ...
        if(eligible){
            fc.registerMember(m);
            System.out.println(m.getName() + " has been registered for class "+ fc.getClassName());
        ...
        if (str.length() > 0) {
            switch (str) {
                ...
                case PALM_LAKE_COMMAND:
                    ...
                    break;
                case PEN_ISLAND_GYM_COMMAND:
                    printGymInfo(chain.lookupGymByName(PEN_ISLAND_GYM_NAME));
                    break;
