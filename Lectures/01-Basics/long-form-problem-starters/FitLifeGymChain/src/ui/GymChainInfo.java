...
public class GymChainInfo {
    ...
    public static final String PEN_ISLAND_GYM_NAME = "Penisland";
    public static final String YOUR_MOM_MEMBER_NAME = "Your Mom";
    ...
    private static void loadMembers(GymChain chain){
        ...
        Member m4 = new Member(YOUR_MOM_MEMBER_NAME);
    ...
    private static void loadGyms(GymChain chain){
        ...
        Gym g4 = new Gym(PEN_ISLAND_GYM_NAME);
        initializeGym0(g4);
        chain.addGym(g4);
    }
