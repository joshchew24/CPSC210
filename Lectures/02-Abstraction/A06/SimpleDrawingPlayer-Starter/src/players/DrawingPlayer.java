...
public class DrawingPlayer implements ActionListener {
    ...
    private List<Rectangle> lastColumnPlayed;
    private List<Rectangle> shapesInColumn;
    ...
    public DrawingPlayer(Drawing drawing, Timer timer){
        ...
        this.timer = timer;
        playingColumn = 0;
        lastColumnPlayed = new ArrayList<Rectangle>();
        shapesInColumn = new ArrayList<Rectangle>();
    }
    ...
    private void selectAndPlayShapes() {
        ...
        for (Rectangle shape : lastColumnPlayed) {
            if (!shapesInColumn.contains(shape)) {
                shape.unselectAndStopPlaying();
            }
        }

        for (Rectangle shape : shapesInColumn) {
