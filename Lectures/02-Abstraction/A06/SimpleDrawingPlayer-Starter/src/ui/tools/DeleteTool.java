...
public class DeleteTool extends Tool {
	...
	public void mousePressedInDrawingArea(MouseEvent e) {
		rectangleToDelete = editor.getShapeInDrawing(e.getPoint());
		if (rectangleToDelete != null) {
			rectangleToDelete.selectAndPlay();
		}
	}
	...
	public void mouseReleasedInDrawingArea(MouseEvent e) {
		if (rectangleToDelete != null) {
		    rectangleToDelete.unselectAndStopPlaying();
			editor.removeFromDrawing(rectangleToDelete);
			rectangleToDelete = null;
		}
	}
